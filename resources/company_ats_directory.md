...
| Teladoc Health | Workday | `teladoc.wd503.myworkdayjobs.com` | Not a named target company — surfaced via Jon finding a LinkedIn posting, confirmed live 2026-09-16 via the Workday CXS API pattern (`/wday/cxs/{tenant}/{site}/job/{path}`, works as a direct GET). Worth checking each pass given the direct fit: conversation design + generative AI in a regulated industry closely parallels Jon's Credit Karma AI dispute-filing work. |
